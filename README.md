...
You can load templates from binary data generated by [go-bindata](https://github.com/jteeuwen/go-bindata) by setting the `Asset` function (which is generated by go-bindata) to the `generator`.
